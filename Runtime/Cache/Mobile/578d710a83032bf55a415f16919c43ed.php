...
<div id="menu"></div>
        <div id="main-content">
            ...
            <div class="sitemap">
                <a href="#" onclick="javascript:setMenu('SPORTS','SPORT_WOMEN');" data-ajax="false" class="btn-back ui-icon-carat-l ui-alt-icon"></a>
                <span class="maptext">
                    <?php if(is_array($category_family)): $i = 0; $__LIST__ = $category_family;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i; if($key==0){ ?>
                        <a data-ajax="false" href="#" onclick="javascript:setMenu('<?php echo $item['ename'];?>');"><?php echo $item['ename'];?></a>
                        ／
                        <?php }?>
                        
                        <?php if($key==1){ ?>
                        <a data-ajax="false" href="#" onclick="javascript:setMenu('<?php echo $category_family[0]['ename'];?>');"><?php echo $item['name'];?></a>
                        ／
                        <?php }?>
                        
                        <?php if($key==2){ ?>
                        <a data-ajax="false" href="#"><?php echo $item['name'];?></a>
                        <?php } endforeach; endif; else: echo "" ;endif; ?>
                    
                </span>
            </div>
            <div id="display-mode" class="box-gray alignc display-mode-color">
                <span data-value="style">依款式排列</span>
            </div>
...
<div id="main-footer">
    <table>
        <tr>
            ...
            <td id="lativ-cart" class="minicart" style="width: 25%;">
                <span url="<?php echo U('Cart/index');?>" buycount="0">结算(0)</span>
            </td>
        </tr>
    </table>
</div>
