...
<div id="menu"></div>
        <div id="main-content">
			...
			<div class="sitemap">
				<a href="#" onclick="javascript:setMenu('MEN');" data-ajax="false" class="btn-back ui-icon-carat-l ui-alt-icon ui-link"></a>
				<span class="maptext">
					<a href="#" onclick="javascript:setMenu('MEN');" data-ajax="false" class="ui-link">NEW！<?php echo ($cinfo['name']); ?>上新</a>
				</span>
			</div>
			<input id="actionUrl" name="actionUrl" pageindex="0" type="hidden" value="/Product/GetNewArrivalList?MainCategory=MEN">
