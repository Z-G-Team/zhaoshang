				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Nav/add");?>">

								<div class="control-group">
									<label class="control-label">导航类型</label>
									<div class="controls">
										<select id="type" class="medium m-wrap" name="type">
						                    <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($info); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap medium" placeholder="名称">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="url" id="url" class="m-wrap medium" placeholder="连接地址">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
