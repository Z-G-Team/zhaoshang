                ...
                <div class="tabbable portlet-tabs">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="portlet_tab1">
                            ...
                            <!-- BEGIN FORM-->
                            <form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Member/edit");?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="password" id="password" class="m-wrap large" placeholder="密码" >
                                        <span class="help-inline" style="color:red;">*(为空则不修改)</span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="head_img" id="head_img" value="<?php echo ($info['head_img']); ?>"  class="m-wrap large">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img src="<?php echo ($info['head_img']); ?>" width="120" height="120" class="showimg">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <label class="radio">
                                        <input type="radio" name="sex" value="2" <?php if($info['sex']==2){ echo 'checked';} ?>/>
                                        女
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="province" class="medium m-wrap" name="province">
                                            ...
                                            <?php if(is_array($region)): $i = 0; $__LIST__ = $region;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item['id']); ?>"  <?php if($item['id']==$info['province']){ echo 'selected'; } ?>>
                                                    <?php echo ($item['name']); ?>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="city" class="medium m-wrap" name="city">
                                            ...
                                            <?php if(is_array($city)): $i = 0; $__LIST__ = $city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item['id']); ?>"  <?php if($item['id']==$info['city']){ echo 'selected'; } ?>>
                                                    <?php echo ($item['name']); ?>
                                                </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="area" class="medium m-wrap" name="area">
                                            ...
                                            <?php if(is_array($area)): $i = 0; $__LIST__ = $area;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item['id']); ?>" <?php if($item['id']==$info['area']){ echo 'selected'; } ?>>
                                                    <?php echo ($item['name']); ?>
                                                </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
