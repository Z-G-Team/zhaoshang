...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="<?php echo U('Cuxiao/index');?>">促销列表</a>
				<span class="icon-angle-right"></span>
			</li>
			<li><a href="javascript:;">新增促销</a></li>
		</ul>
	</div>
</div>
<!-- END PAGE HEADER-->
		...
		<div class="portlet box blue tabbable">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="hidden-480">促销表单</span>
				</div>
			</div>
				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Cuxiao/add");?>">
								<div class="control-group">
									<label class="control-label">促销名称</label>
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap medium" placeholder="促销名称">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="type" id="type" class="m-wrap medium">
											<?php if(is_array($C_TYPE)): $i = 0; $__LIST__ = $C_TYPE;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($item); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="min_num" id="min_num" class="m-wrap small" placeholder="最低购买数量" value="1">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>


								<div class="control-group" id="show_discount" style="display:none;">
									<label class="control-label">折扣力度</label>
									<div class="controls">
										<input type="text" name="discount" id="discount" class="m-wrap medium" placeholder="折扣力度">
										<span class="help-inline" style="color:red;">*（如果打95折请填写9.5）</span>
									</div>
								</div>

								<div class="control-group" id="show_price">
									<label class="control-label">固定价格</label>
									<div class="controls">
										<input type="text" name="price" id="price" class="m-wrap medium" placeholder="固定价格">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="begin_time" id="begin_time" class="m-wrap medium my_date" placeholder="活动开始时间">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="end_time" id="end_time" class="m-wrap medium my_date" placeholder="活动结束时间">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
