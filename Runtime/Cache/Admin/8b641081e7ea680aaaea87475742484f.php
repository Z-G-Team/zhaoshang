...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
			...
			<li><a href="javascript:;">发布商品</a></li>
		</ul>
	</div>
</div>
<!-- END PAGE HEADER-->
				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Product/add");?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select id="fpid" class="medium m-wrap" name="fpid">
						                    ...
						                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><option value="<?php echo ($info['id']); ?>"><?php echo ($info['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap large" placeholder="商品名称">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="num" id="num" class="m-wrap large" placeholder="商品编号">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="keys" id="keys" class="m-wrap large" placeholder="SEO关键字">
										<span class="help-inline" style="color:red;"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea class="large m-wrap" rows="3" name="description" id="description" placeholder="SEO描述"></textarea>
										<span class="help-inline" style="color:red;"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="price" id="price" class="m-wrap small" value='0.00'>

										<span class="help-inline">市场价</span>
										<input type="text" name="market_price" id="market_price" class="m-wrap small" value='0.00'>
										
										<span class="help-inline">成本价</span>
										<input type="text" name="cost_price" id="cost_price" class="m-wrap small" value='0.00'>

										<span class="help-inline">库存量</span>
										<input type="text" name="stock" id="stock" class="m-wrap small" value='0'>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="weight" id="weight" class="m-wrap small" value='0'>

										<span class="help-inline">销售量</span>
										<input type="text" name="sales" id="sales" class="m-wrap small" value='0'>

										<span class="help-inline">点击量</span>
										<input type="text" name="clicks" id="clicks" class="m-wrap small" value='0'>
				
										<span class="help-inline">收藏量</span>
										<input type="text" name="collects" id="collects" class="m-wrap small" value='0'>
									</div>
								...
								<div class="control-group" id="show_sku_imgs">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="sort" id="sort" class="m-wrap small" value='50'>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<label class="radio">
											<input type="radio" name="checked" value="1" checked />
											上架
										</label>
									</div>
								</div>
		   ...
		   // initiate layout and plugins
	        ...
	        function constructSku(arrs){
	            for(k in arrs){
	                ...
	                // specsHtml += '<td>' + '<input class="inputtext sku_input sku_promotion_price1" type="text" value="' + promotion_price1 + '" name="' + tv + 'h" >' + '</td>';
