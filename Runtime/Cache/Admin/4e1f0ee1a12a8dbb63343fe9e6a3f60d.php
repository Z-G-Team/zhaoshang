                ...
                <div class="tabbable portlet-tabs">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="portlet_tab1">
                            ...
                            <!-- BEGIN FORM-->
                            <form class="form-horizontal" id="mForm" method="post" action="<?php echo U("User/add");?>">
                                <div class="control-group">
                                    <label class="control-label">用户名</label>
                                    <div class="controls">
                                        <input type="text" name="username" id="username" class="m-wrap medium" placeholder="用户名" value="<?php echo ($info['username']); ?>" >
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="tel" id="tel" class="m-wrap medium" placeholder="电话" value="<?php echo ($info['tel']); ?>">
                                        <span class="help-inline" style="color:red;"></span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="email" id="email" class="m-wrap medium" placeholder="邮箱" value="<?php echo ($email['tel']); ?>">
                                        <span class="help-inline" style="color:red;"></span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<select id="role" class="medium m-wrap" name="role">
											...
											<?php if(is_array($juese)): $i = 0; $__LIST__ = $juese;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item['id']); ?>" <?php if($info['role']==$item['id']){ echo 'selected=""';}?>>
													<?php echo $item['name']?>
