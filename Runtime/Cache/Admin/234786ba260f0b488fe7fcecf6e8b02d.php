	...
	<div class="span12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption"><i class="icon-edit"></i>促销</div>
				<!-- <div class="tools">
			...
			<div class="portlet-body">
				<div class="clearfix">
					<div class="btn-group">
						<a href="<?php echo U('Cuxiao/add');?>" class="btn green">
							<i class="icon-plus"></i>添加促销
						</a>
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
							<td><?php echo ($info['id']); ?></td>
				          	...
				          	<td>
				          		<a class="btn mini blue" href="<?php echo U('CuxiaoProduct/index', array('pid'=>$info['id']));?>"><i class="icon-share"></i>查看商品</a>

				          		<a class="btn mini purple" href="<?php echo U('Cuxiao/edit', array('id'=>$info['id']));?>">
