...
<div class="row-fluid">
    <div class="span12">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo U('Adgroup/index', array('type'=>$adgroup['type']));?>">广告组</a>
                <span class="icon-angle-right"></span>
            </li>
            <li>
                <a href="<?php echo U('Advert/index', array('pid'=>$adgroup['id']));?>">广告列表</a>
                <span class="icon-angle-right"></span>
            </li>
            <li><a href="javascript:;">编辑广告</a>(<?php echo ($adgroup['name']); ?>)</li>
        </ul>
    </div>
</div>
<!-- END PAGE HEADER-->
                ...
                <div class="tabbable portlet-tabs">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="portlet_tab1">
                            ...
                            <!-- BEGIN FORM-->
                            <form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Advert/edit");?>">
                                <input type="hidden" name="id" id="id" value="<?php echo $advert['id'];?>">

                                <div class="control-group">
                                    <label class="control-label">名称</label>
                                    <div class="controls">
                                        <input type="text" name="name" id="name" class="m-wrap medium" placeholder="广告名称" value="<?php echo ($advert['name']); ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="url" id="url" class="m-wrap large" placeholder="链接" value="<?php echo ($advert['url']); ?>">
                                        <span class="help-inline" style="color:red;">*</span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="image" id="image" value="<?php echo ($advert['image']); ?>"  class="m-wrap large">
                                        <iframe src="<?php echo U('Images/upload',array('type'=>'image'));?>" scrolling="no" topmargin="no" width="330" height="30" marginwidth="0" marginheight="0" frameborder="0" align="center" class="imageIfram"></iframe>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="radio">
                                        <input type="radio" name="state" value="0" <?php echo $advert['state']==0 ? 'checked' : ''; ?>/>
                                        隐藏
                                        </label>
                                        <label class="radio">
                                        <input type="radio" name="state" value="1" <?php echo $advert['state']==1 ? 'checked' : ''; ?> />
                                        显示
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="description" name="description" cols="3"><?php echo ($advert['description']); ?></textarea>
