	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="clearfix">
					<div class="btn-group">
						<a href="<?php echo U('User/add');?>" class="btn green">
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
							<th scope="row"><?php echo ($info['id']); ?></th>
				          	...
				          	<td><?php echo ($juese[$info['role']]['name']); ?></td>
				          	<td><?php echo ($info['add_time']); ?></td>
				          	<td><?php echo $info['status']==1?'启用':'禁用';?></td>
				          	<td>
				          		<a class="btn mini purple" href="<?php echo U('User/edit', array('id'=>$info['id']));?>"><i class="icon-edit"></i>&nbsp;编辑</a>
								
				          		<a class="btn mini black delete" href="javascript:;" data-id="<?php echo ($info['id']); ?>"><i class="icon-trash"></i>&nbsp;<?php echo $info['status']==1?'禁用':'启用';?></a>
				          	</td>
