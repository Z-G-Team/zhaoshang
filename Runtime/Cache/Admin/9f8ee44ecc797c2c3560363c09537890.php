...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="<?php echo U('Region/index');?>">城市列表</a>
			</li>
		</ul>
	...
	<div class="span12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption"><i class="icon-edit"></i>城市</div>
				<!-- <div class="tools">
			...
			<div class="portlet-body">
				<div class="clearfix">
					<div class="btn-group">
						<a href="<?php echo U('Region/add', array('pid'=>$pid));?>" class="btn green">
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
							<td><?php echo ($info['id']); ?></td>
				          	...
				          	<td><a href="<?php echo U('Region/index', array('pid'=>$info['id']));?>"><?php echo ($info['name']); ?></a></td>
				          	<td>
				          		<a class="btn mini green-stripe" href="<?php echo U('Region/index', array('pid'=>$info['id']));?>">查看下级</a>

				          		<a class="btn green mini" href="<?php echo U('Region/add', array('pid'=>$info['id']));?>">
				          		<i class="icon-plus"></i>添加子城市</a>

				          		<a class="btn mini purple" href="<?php echo U('Region/edit', array('id'=>$info['id']));?>">
				          		<i class="icon-edit"></i>编辑</a>

								<a data-id="<?php echo ($info['id']); ?>" href="javascript:;" class="btn mini black delete"><i class="icon-trash"></i>删除</a>
				          	</td>
