	...
	<div class="span12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption"><i class="icon-edit"></i>属性列表</div>
				<!-- <div class="tools">
			...
			<div class="portlet-body">
				<div class="clearfix">
					<div class="btn-group">
						<a href="<?php echo U('Attribute/add', array('pid'=>$pid));?>" class="btn green">
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
				          	...
				          	<td>
				          		<a class="btn mini purple" href="<?php echo U('Attribute/edit', array('id'=>$info['id']));?>"><i class="icon-edit"></i>编辑</a>
	...
	<script type="text/javascript" >
		...
		jQuery(document).ready(function() {       
		   ...
		   //删除
			...
			// 	var id = $(this).data('id');
			// 	if(confirm('确定删除记录这条记录吗')){
			// 		$.ajax({
			// 			url : '<?php echo U("Attribute/delete");?>',
			// 			data : {id:id},
			// 			dataType : 'json',
			// 			type : 'post',
