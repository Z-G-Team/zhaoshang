	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="clearfix">
					<div class="btn-group">
						<a href="<?php echo U('Role/add');?>" class="btn green">
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
							<td><?php echo ($info['id']); ?></td>
				          	...
				          	<td><?php echo (is_show($info['state'])); ?></td>
				          	<td><a class="btn mini blue" href="<?php echo U('Role/auth', array('id'=>$info['id']));?>"><i class="icon-pencil"></i>授权</a></td>
				          	<td>
				          		<a class="btn mini purple" href="<?php echo U('Role/edit', array('id'=>$info['id']));?>"><i class="icon-edit"></i>编辑</a>
