	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				...
				<div class="btn-group">
					<a href="<?php echo U('Article/add');?>" class="btn green">
				...
				<div class="row-fluid">
					<div>
						...
						<form class="form-horizontal" action="<?php echo U('Article/index');?>" method="get">
							<label>
								<select id="pid" name="pid" class="m-wrap small">
			                        <option value="">请选择分类</option>
			                        <?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fcy): $mod = ($i % 2 );++$i;?><option value="<?php echo ($fcy["id"]); ?>" <?php if($fcy['id']==I('get.pid')){ echo 'selected';} ?>><?php echo ($fcy["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			                    </select>
							</label>
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
				          	...
				          	<td><img src="<?php echo ($info['main_img']); ?>" height="30" width="30"></td>
				          	<td><?php echo ($clist[$info['pid']]['name']); ?></td>
				          	<td><?php echo ($info['name']); ?></td>
				          	<td><?php echo ($info['origin']); ?></td>
				          	<td><?php echo ($info['add_time']); ?></td>
		
				          	<td>
				          		<a class="btn mini purple" href="<?php echo U('Article/edit', array('id'=>$info['id']));?>"><i class="icon-edit"></i>编辑</a>
