	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="clearfix">
					<div class="btn-group">
						<a href="<?php echo U('Nav/add');?>" class="btn green">
							<i class="icon-plus"></i>添加导航
						</a>
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
							<td><?php echo ($info['id']); ?></td>
				          	<td><?php echo ($types[$info['type']]); ?></td>
				          	<td><?php echo ($info['name']); ?></td>
				          	<td><?php echo ($info['url']); ?></td>
				          	<td><?php echo $info['status']==1?'开启':'关闭';?></td>
				          	<td><?php echo ($info['sort']); ?></td>
				          	<td>
				          		<a class="btn mini purple" href="<?php echo U('Nav/edit', array('id'=>$info['id'], 'type'=>$type));?>">
