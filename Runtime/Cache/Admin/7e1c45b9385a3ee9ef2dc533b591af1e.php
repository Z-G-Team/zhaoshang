		...
		<div class="portlet box blue tabbable">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="hidden-480">规格表单</span>
				</div>
			</div>
				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Specs/edit");?>">
								<input type="hidden" id="id" name="id" value="<?php echo ($info['id']); ?>">
								<div class="control-group">
									<label class="control-label">规格名称</label>
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap medium" placeholder="规格名称" value="<?php echo ($info['name']); ?>">
								...
								<div class="control-group">
									<label class="control-label">商品是否添加图片</label>
									<div class="controls">
										<label class="radio">
											<input type="radio" name="is_img" value="0" checked="true" <?php echo $info['is_img']==0 ? 'checked="true"' : '' ;?>/>
											否
										</label>
										<label class="radio">
											<input type="radio" name="is_img" value="1" <?php echo $info['is_img']==1 ? 'checked="true"' : '' ;?>/>
											是
										</label>
									</div>
								</div>
