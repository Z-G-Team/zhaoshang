...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
		    ...
		    <?php if(is_array($bars)): $i = 0; $__LIST__ = $bars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cinfo): $mod = ($i % 2 );++$i;?><li>
					<a href="<?php echo U('Category/index',array('pid'=>$cinfo['id']));?>"><?php echo ($cinfo['name']); ?></a>
					<i class="icon-angle-right"></i>
				</li><?php endforeach; endif; else: echo "" ;endif; ?>
		    <li><a href="javascript:;"><?php echo ($pinfo['name']); ?></a></li>
		</ul>
	...
	<div class="span12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption"><i class="icon-edit"></i>规格列表</div>
				<!-- <div class="tools">
			...
			<div class="portlet-body">
				<div class="clearfix">
					<div class="btn-group">
						<a href="<?php echo U('Specs/add', array('pid'=>$pid));?>" class="btn green">
							<i class="icon-plus"></i>添加规格
						</a>
					</div>
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
				          	...
				          	<td><?php echo $info['is_img']?'是':'否';?></td>
				          	<td><?php echo ($info['values']); ?></td>
				          	<td>
				          		<a class="btn mini purple" href="<?php echo U('Specs/edit', array('id'=>$info['id']));?>"><i class="icon-edit"></i>编辑</a>
