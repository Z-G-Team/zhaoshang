...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
			...
			<li><a href="javascript:;">新增导航</a></li>
		</ul>
	</div>
</div>
<!-- END PAGE HEADER-->
		...
		<div class="portlet box blue tabbable">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="hidden-480">导航表单</span>
				</div>
			</div>
				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Nav/edit");?>">
								<input type="hidden" id="id" name="id" value="<?php echo ($info['id']); ?>">
								<div class="control-group">
									<label class="control-label">导航类型</label>
									<div class="controls">
										<select id="type" class="medium m-wrap" name="type">
						                    <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$infos): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key==$info['type']){ echo 'selected';} ?>><?php echo ($infos); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap medium" placeholder="名称" value="<?php echo ($info['name']); ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="url" id="url" class="m-wrap medium" placeholder="连接地址" value="<?php echo ($info['url']); ?>">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="sort" id="sort" class="m-wrap small" value="<?php echo ($info['sort']); ?>" >
									</div>
								</div>
