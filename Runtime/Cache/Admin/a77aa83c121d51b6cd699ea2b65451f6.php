				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Menu/edit");?>">
								<input type="hidden" id="id" name="id" value="<?php echo ($info['id']); ?>">

								<div class="control-group">
									<label class="control-label">名称</label>
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap medium" placeholder="菜单名称" value="<?php echo ($info['name']); ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select id="pid" class="medium m-wrap" name="pid">
											...
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item['id']); ?>" <?php echo $info['pid'] == $item['id'] ? 'selected="true"' : ''?>>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="module"  id="module" class="m-wrap medium" placeholder="模块名称"  value="<?php echo ($info['module']); ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="controller" id="controller" class="m-wrap medium" placeholder="控制器名" value="<?php echo ($info['controller']); ?>">
										<span class="help-inline"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="action" id="action" class="m-wrap medium" placeholder="方法名" value="<?php echo ($info['action']); ?>">
										<span class="help-inline"></span>
									</div>
								</div>
