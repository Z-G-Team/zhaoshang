				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Article/edit");?>">
								<input type="hidden" id="id" name="id" value="<?php echo ($info['id']); ?>">
								<div class="control-group">
									<label class="control-label">标题</label>
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap large" placeholder="标题" value="<?php echo ($info['name']); ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="origin" id="origin" class="m-wrap large" placeholder="来源" value="<?php echo ($info['origin']); ?>">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="pid" id="pid">
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item['id']); ?>" <?php if($item['id']==$info['pid']){ echo 'selected'; } ?>><?php echo ($item['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span data-index="1" class="" id="logoimage">
											<img src="<?php echo ((isset($info['main_img']) && ($info['main_img'] !== ""))?($info['main_img']):'/Public/Admin/images/nophoto.jpg'); ?>" width="120" height="120" class="showimg_main_img">
				                            <input type="hidden" name="main_img" id="main_img" value="<?php echo ($info['main_img']); ?>">
				                        </span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="summ" id="summ" class="m-wrap large" placeholder="摘要"><?php echo ($info['summ']); ?></textarea>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="content" id="content" class="m-wrap large" placeholder="内容介绍"><?php echo ($info['content']); ?></textarea>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="url" id="url" class="m-wrap large" placeholder="外部链接" value="<?php echo ($info['url']); ?>">
