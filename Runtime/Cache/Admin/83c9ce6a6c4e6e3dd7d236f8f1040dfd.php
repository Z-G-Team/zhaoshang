...
<div class="row-fluid">
    <div class="span12">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo U('Adgroup/index');?>">广告组</a>
                <span class="icon-angle-right"></span>
            </li>
            <li><a href="javascript:;">编辑广告组</a></li>
        </ul>
    </div>
</div>
<!-- END PAGE HEADER-->
        ...
        <div class="portlet box blue tabbable">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="hidden-480">广告组表单</span>
                </div>
            </div>
                ...
                <div class="tabbable portlet-tabs">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="portlet_tab1">
                            ...
                            <!-- BEGIN FORM-->
                            <form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Adgroup/edit");?>">
                                <input type="hidden" name="id" id="id" value="<?php echo $adgroup['id'];?>">

                                <div class="control-group">
                                    <label class="control-label">名称</label>
                                    <div class="controls">
                                        <input type="text" name="name" id="name" class="m-wrap medium" placeholder="广告组名称" value="<?php echo ($adgroup['name']); ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text"  class="m-wrap medium" placeholder="广告组名称" value="<?php echo ($adtype[$adgroup['type']]); ?>" disabled="true">
                                        <input type="hidden" name="type" id="type" value="<?php echo ($adgroup['type']); ?>">
                                        <span class="help-inline" style="color:red;">*</span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="width"  id="width" class="m-wrap small" placeholder="宽度" value="<?php echo ($adgroup['width']); ?>">
                                        <span class="help-inline">单位px</span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="height"  id="height" class="m-wrap small" placeholder="高度" value="<?php echo ($adgroup['height']); ?>">
                                        <span class="help-inline">单位px</span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="radio">
                                        <input type="radio" name="state" value="0" <?php echo $adgroup['state']==0 ? 'checked' : ''; ?>/>
                                        隐藏
                                        </label>
                                        <label class="radio">
                                        <input type="radio" name="state" value="1" <?php echo $adgroup['state']==1 ? 'checked' : ''; ?> />
                                        显示
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="description" name="description" cols="3"><?php echo ($adgroup['description']); ?></textarea>
