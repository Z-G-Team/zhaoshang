...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
		    ...
		    <?php if(is_array($bars)): $i = 0; $__LIST__ = $bars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cinfo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Category/index',array('pid'=>$cinfo['id']));?>"><?php echo ($cinfo['name']); ?></a><i class="icon-angle-right"></i></li><?php endforeach; endif; else: echo "" ;endif; ?>
		    <li>
	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="clearfix">
					<div class="btn-group">
						<a href="<?php echo U('Category/add', array('pid'=>$pid));?>" class="btn green">
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
				          	...
				          	<td><?php echo ($info['ename']); ?></td>
				          	<td><?php echo ($pname); ?></td>
				          	<td><?php echo (is_show($info['isindex'])); ?></td>
				          	<td><?php echo ($info['sort']); ?></td>
				          	<td><?php echo ($info['addtime']); ?></td>
				          	<td>
				          		<a class="btn mini green-stripe" href="<?php echo U('Category/index', array('pid'=>$info['id'],'token'=>$token));?>">查看子分类</a>

				          		<a class="btn mini green" href="<?php echo U('Category/add', array('pid'=>$info['id'],'token'=>$token));?>"><i class="icon-plus"></i>添加子分类</a>

				          		<a class="btn mini green-stripe" href="<?php echo U('Specs/index', array('pid'=>$info['id'] ));?>">规格管理</a>

				          		<a class="btn mini green-stripe" href="<?php echo U('Attribute/index', array('pid'=>$info['id'] ));?>">属性管理</a>

				          		<a class="btn mini purple" href="<?php echo U('Category/edit', array('id'=>$info['id']));?>"><i class="icon-edit"></i>编辑</a>
