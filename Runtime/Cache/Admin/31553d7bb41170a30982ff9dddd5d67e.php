...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
			...
			<li><a href="javascript:;">新增菜单</a></li>
		</ul>
	</div>
</div>
<!-- END PAGE HEADER-->
				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Menu/add");?>">
								<input type="hidden" id="type" name="type" value="<?php echo ($type); ?>">

								<div class="control-group">
									<label class="control-label">名称</label>
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap medium" placeholder="菜单名称">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select id="pid" class="medium m-wrap" name="pid">
											...
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item['id']); ?>" <?php echo $pid == $item['id'] ? 'selected="true"' : ''?>>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="module"  id="module" class="m-wrap medium" placeholder="模块名称">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="controller" id="controller" class="m-wrap medium" placeholder="控制器名">
										<span class="help-inline"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="action" id="action" class="m-wrap medium" placeholder="方法名">
										<span class="help-inline"></span>
									</div>
								</div>
