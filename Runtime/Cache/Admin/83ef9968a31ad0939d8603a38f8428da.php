...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
			...
			<li><a href="javascript:;">新增属性</a></li>
		</ul>
	</div>
</div>
<!-- END PAGE HEADER-->
				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Attribute/add");?>">
								<div class="control-group">
									<label class="control-label">属性名称</label>
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap medium" placeholder="属性名称">
