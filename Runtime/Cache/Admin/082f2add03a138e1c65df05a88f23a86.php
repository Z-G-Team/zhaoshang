...
<div class="row-fluid">
    <div class="span12">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="javascript:;">新增广告组</a></li>
        </ul>
    </div>
</div>
<!-- END PAGE HEADER-->
                ...
                <div class="tabbable portlet-tabs">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="portlet_tab1">
                            ...
                            <!-- BEGIN FORM-->
                            <form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Adgroup/add");?>">
 
                                <div class="control-group">
                                    <label class="control-label">名称</label>
                                    <div class="controls">
                                        <input type="text" name="name" id="name" class="m-wrap medium" placeholder="广告组名称">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text"  class="m-wrap medium" placeholder="广告组名称" value="<?php echo ($adtype[$type]); ?>" disabled="true">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="width"  id="width" class="m-wrap small" placeholder="宽度">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="height"  id="height" class="m-wrap small" placeholder="高度">
                                        <span class="help-inline">单位px</span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="description" name="description" cols="3"></textarea>
