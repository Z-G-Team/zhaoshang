	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="clearfix">
					<div class="btn-group">
						<a href="<?php echo U('ArticleCategory/add');?>" class="btn green">
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
							<td><?php echo ($info['id']); ?></td>
				          	...
				          	<td>
				          		<a class="btn mini purple" href="<?php echo U('ArticleCategory/edit', array('id'=>$info['id'], 'type'=>$type));?>">
...
<!-- END FOOTER -->
	...
	<script>
		...
		function todelete(id, rmtr){
            $.ajax({
                url : '<?php echo U("ArticleCategory/delete");?>',
                data : {id : id},
                dataType : 'json',
                type : 'post',
