...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
			...
			<li><a href="javascript:;">编辑促销</a></li>
		</ul>
	</div>
</div>
<!-- END PAGE HEADER-->
				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Cuxiao/edit");?>">
								<input type="hidden" id="id" name="id" value="<?php echo ($info['id']); ?>">
								<div class="control-group">
									<label class="control-label">促销名称</label>
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap medium" placeholder="促销名称" value="<?php echo ($info['name']); ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="min_num" id="min_num" class="m-wrap small" placeholder="最低购买数量" value="1" value="<?php echo ($info['min_num']); ?>">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="begin_time" id="begin_time" class="m-wrap medium my_date" placeholder="活动开始时间" value="<?php echo ($info['begin_time']); ?>">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="end_time" id="end_time" class="m-wrap medium my_date" placeholder="活动结束时间" value="<?php echo ($info['end_time']); ?>">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="radio">
                                        <input type="radio" name="status" value="2" <?php if($info['status']==2){ echo 'checked';}?>/>
                                        关闭
                                        </label>
                                        <label class="radio">
