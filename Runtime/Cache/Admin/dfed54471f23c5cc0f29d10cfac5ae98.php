				...
				<div class="tabbable portlet-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_tab1">
							...
							<!-- BEGIN FORM-->
							<form class="form-horizontal" id="mForm" method="post" action="<?php echo U("Category/edit");?>">
								<input type="hidden" id="id" name="id" value="<?php echo ($info['id']); ?>">
								<div class="control-group">
									<label class="control-label">分类名称</label>
									<div class="controls">
										<input type="text" name="name" id="name" class="m-wrap medium" placeholder="分类名称" value="<?php echo ($info['name']); ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="ename" id="ename" class="m-wrap medium" placeholder="英文名称" value="<?php echo ($info['ename']); ?>">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="name" id="name" value="<?php echo ((isset($pinfo['name']) && ($pinfo['name'] !== ""))?($pinfo['name']):'顶级分类'); ?>" class="m-wrap medium" disabled="true">
										<span class="help-inline" style="color:red;">*</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea class="large m-wrap" rows="3" name="des" id="des"><?php echo ($info['des']); ?></textarea>
										<span class="help-inline" style="color:red;"></span>
									</div>
								</div>
